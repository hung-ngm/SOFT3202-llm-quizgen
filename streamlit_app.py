...
def generate_quizzes(document):
    ...
    response = openai.ChatCompletion.create(
        ...
        messages = [
            {
                "role": "system",
                "content": "You are professor in OOP Software Construction and Design. You will create a quiz questions for students of the lecture on software design patterns so that students can understand more about the subject.",
            },
            {
                "role": "user",
                "content": prompt,
...
class Message:
    ...
    def __enter__(self):
        ...
        icon_area.image(self.ai_icon, caption="SOFT3202 LLM")
...
if __name__ == "__main__":
    ...
    st.title("Local SOFT3202 LLM")

    if openai_api_key:
        loader = PyPDFLoader("./source_documents/SOFT3202DesignPatterns.pdf")
